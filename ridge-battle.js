...
export function battlePace(bot,player,dt){
 ...
 // Занос теперь стоит скорости (потолок газа и скраб в ridge-drift): чтобы бот не отставал в дугах,
 // его догоняющее ускорение выросло на ту же величину, что и потери.
 const target=player.speed>12?clamp(gap*.42+closing*.9,-3.0,3.8)*finish:0;
