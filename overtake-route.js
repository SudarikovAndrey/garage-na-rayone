...
export function overtakeOpponent(opp){return {...opp,id:0,practice:true,trackId:'overtake',name:'ТАКСИСТ',paint:'ivory',car:10,levels:[5,3,3],map:7,distance:OVERTAKE_DISTANCE,shift:5300,launchRpm:5200,reaction:.3,startAssist:false,boss:false,captain:false,requiredPerfect:0,beat:'ОБГОН · СВОБОДНЫЙ ЗАЕЗД',decal:'',window:1,launchAuto:.8,overtake:true,ghostTime:19};}
