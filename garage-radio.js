...
export class GarageRadio {
  constructor({root,getState,prepare,storage=localStorage,media=new Audio()}) {
    ...
    this.enabled=saved?.enabled===true;this.unlocked=false;this.blocked=false;this.failed=false;this.loading=false;
