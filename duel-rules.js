...
export function verifyReplay(inputs,build,distance=DUEL.distance){
 ...
 return {time:car.finishTime,perfect:car.perfect,good:car.good,missed:car.missed};
}
...
export const DUEL_BOTS=[
 {id:'shurup',name:'Шуруп',car:1,paint:'orange',skill:1,mix:[.58,.30,.12],kit:['rims']},
 {id:'sedoy',name:'Седой',car:1,paint:'cherry',skill:2,mix:[.48,.18,.34],kit:['rims','bumpers']},
 {id:'shket',name:'Шкет',car:1,paint:'blue',skill:0,mix:[.62,.30,.08],kit:['rims']},
 {id:'palych',name:'Палыч',car:2,paint:'black',skill:3,mix:[.36,.20,.44],kit:['rims','skirts']},
 {id:'gvozd',name:'Гвоздь',car:0,paint:'silver',skill:4,mix:[.44,.38,.18],kit:['rims','fenders','bumpers']},
 {id:'kabanchik',name:'Кабанчик',car:2,paint:'green',skill:1,mix:[.66,.25,.09],kit:['rims','bumpers']},
 {id:'filya',name:'Филя',car:1,paint:'ivory',skill:2,mix:[.40,.42,.18],kit:['rims','skirts']},
 {id:'baton',name:'Батон',car:2,paint:'ivory',skill:0,mix:[.70,.20,.10],kit:['rims','fenders']},
 {id:'ryzhiy',name:'Рыжий',car:1,paint:'orange',skill:3,mix:[.42,.22,.36],kit:['rims','spoiler','bumpers']},
 {id:'klesch',name:'Клещ',car:0,paint:'cherry',skill:4,mix:[.50,.34,.16],kit:['rims','skirts','fenders','spoiler']},
 {id:'truba',name:'Труба',car:1,paint:'green',skill:1,mix:[.38,.52,.10],kit:['rims','fenders']},
 {id:'major',name:'Мажор',car:2,paint:'silver',skill:2,mix:[.54,.16,.30],kit:['rims','skirts','spoiler']},
 {id:'kirpich',name:'Кирпич',car:2,paint:'black',skill:0,mix:[.45,.20,.35],kit:['rims','bumpers']},
 {id:'boroda',name:'Борода',car:2,paint:'green',skill:3,mix:[.32,.28,.40],kit:['rims','skirts','fenders']},
 {id:'turbo',name:'Турбо',car:2,paint:'blue',skill:4,mix:[.60,.24,.16],kit:['rims','skirts','fenders','spoiler','bumpers']},
 {id:'shtaket',name:'Штакет',car:1,paint:'ivory',skill:1,mix:[.34,.48,.18],kit:['rims','fenders']},
 {id:'dizel',name:'Дизель',car:2,paint:'black',skill:2,mix:[.68,.14,.18],kit:['rims','bumpers','skirts']},
 {id:'maloy',name:'Малой',car:0,paint:'blue',skill:0,mix:[.46,.36,.18],kit:['rims','spoiler']},
 {id:'prizrak',name:'Призрак',car:2,paint:'silver',skill:3,mix:[.38,.18,.44],kit:['rims','skirts','spoiler']},
 ...
 {id:'lyoha',name:'Лёха с Пятой',car:1,paint:'mint',skill:1,mix:[.50,.32,.18],kit:['rims'],decal:'taxi'},
 {id:'zmey',name:'Змей',car:1,paint:'graphite',skill:3,mix:[.44,.20,.36],kit:['rims','skirts','spoiler'],decal:'night-pride',neon:'acid'},
 {id:'santa',name:'Санта',car:2,paint:'bright-white',skill:0,mix:[.72,.18,.10],kit:['rims','bumpers'],decal:'polyot-21'},
 {id:'kosmos',name:'Космос',car:2,paint:'plum',skill:4,mix:[.48,.28,.24],kit:['rims','skirts','fenders','spoiler','bumpers'],decal:'circuit',neon:'violet'},
 {id:'vovan',name:'Вован',car:1,paint:'orange',skill:2,mix:[.56,.26,.18],kit:['rims','fenders'],decal:'forward-88'},
 {id:'ledi',name:'Леди',car:0,paint:'lime',skill:2,mix:[.40,.36,.24],kit:['rims','skirts'],decal:'runners',neon:'raspberry'},
 {id:'stary',name:'Старый',car:2,paint:'garnet',skill:3,mix:[.36,.24,.40],kit:['rims','bumpers','skirts'],decal:'retro-rally'},
 {id:'shnyaga',name:'Шняга',car:1,paint:'khaki',skill:0,mix:[.60,.30,.10],kit:['rims']},
 {id:'metel',name:'Метель',car:2,paint:'snow-queen',skill:1,mix:[.46,.40,.14],kit:['rims','fenders','bumpers'],decal:'north-wind',neon:'ice'},
 {id:'kapitan',name:'Капитан',car:1,paint:'gold',skill:4,mix:[.54,.28,.18],kit:['rims','spoiler','bumpers'],decal:'gold-7',neon:'amber'},
];
const hash=s=>[...s].reduce((n,c)=>(n*33+c.charCodeAt(0))>>>0,5381);
export function botBuild(bot,targetPower){const cls=duelClassFor(targetPower),offset=(hash(bot.id)%15)-7,desired=clamp(targetPower+offset,cls.min,cls.max),base=vehicleStats(CARS[bot.car].id).rating,delta=Math.max(0,desired-base),levels=bot.mix.map((share,i)=>delta*share/[14,5,3][i]),rarity=integer(DUEL_CLASSES.findIndex(c=>c.id===cls.id),0,3),equipment={};for(const slot of bot.kit)equipment[slot]=slot+'-'+rarity;return normalizeDuelBuild({car:bot.car,levels,equipment,paint:bot.paint,decal:bot.decal||DECALS[hash(bot.id)%DECALS.length].id,neon:bot.neon||null});}
