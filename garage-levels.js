...
export const GARAGE_LEVELS=[
 {level:1,roman:'Ⅰ',name:'Бокс на соплях',cost:0,scrap:0,rank:0,discount:0,rankCap:3,kitTier:0,trimTier:1,carSlots:1,description:'Голый бокс, хлам и лампочка',background:0x8d8272,ambient:.66,sun:2.45,tube:17,tubeColor:0xffc27a,rim:.52,environment:.58},
 {level:2,roman:'Ⅱ',name:'Батин угол',cost:3000,scrap:60,rank:5,discount:.10,rankCap:5,kitTier:1,trimTier:2,carSlots:2,description:'Уборка, стеллаж и свой угол',background:0xa5977c,ambient:.72,sun:2.55,tube:26,tubeColor:0xffd19b,rim:.60,environment:.63},
 {level:3,roman:'Ⅲ',name:'Своя мастерская',cost:6000,scrap:90,rank:35,discount:.20,rankCap:7,kitTier:2,trimTier:3,carSlots:3,description:'Верстак, инструмент и рабочий свет',background:0xb8ad96,ambient:.72,sun:2.7,tube:32,tubeColor:0xd0e7ff,rim:.70,environment:.65},
 {level:4,roman:'Ⅳ',name:'Районный сервис',cost:15000,scrap:220,rank:78,discount:.30,rankCap:10,kitTier:3,trimTier:3,carSlots:6,description:'Подъёмник, компрессор и сварка',background:0xabb2a8,ambient:.82,sun:2.7,tube:47,tubeColor:0xd9eeff,rim:.90,environment:.72},
 {level:5,roman:'Ⅴ',name:'Ателье «Ракета»',cost:30000,scrap:380,rank:120,discount:.40,rankCap:15,kitTier:3,trimTier:3,carSlots:13,description:'Чистый пол, диагностика и полный комплект',background:0xb9c4bf,ambient:.92,sun:2.9,tube:64,tubeColor:0xe4f3ff,rim:1.15,environment:.85},
];
...
export function garageUnlockSummary(g){return g.name+' · '+KIT_TIER_NAMES[g.kitTier+1]+' · ранг до '+g.rankCap+' · тюнинг −'+Math.round(g.discount*100)+'%';}
