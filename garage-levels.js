...
export const GARAGE_LEVELS=[
 ...
 {level:4,roman:'Ⅳ',name:'Районный сервис',cost:15000,scrap:220,rank:78,rankCap:10,kitTier:3,trimTier:3,carSlots:6,description:'Подъёмник, компрессор и сварка',background:0xabb2a8,ambient:.82,sun:2.7,tube:47,tubeColor:0xd9eeff,rim:.90,environment:.72},
 {level:5,roman:'Ⅴ',name:'Ателье «Ракета»',cost:30000,scrap:380,rank:120,rankCap:15,kitTier:3,trimTier:3,carSlots:13,description:'Чистый пол, диагностика и полный комплект',background:0xb9c4bf,ambient:.92,sun:2.9,tube:64,tubeColor:0xe4f3ff,rim:1.15,environment:.85},
];
