...
export function sandboxSave(){
 ...
 return {
  ...
  carShards,
  // Лестница прокачки выдаёт только свои четыре машины, а песочница — стенд: тут открыт весь парк,
  // иначе половину моторов не послушать и половину кузовов не посмотреть.
  unlockedCars:CARS.map(()=>true),
