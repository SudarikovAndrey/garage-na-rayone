...
export const BUMPS=[{at:80,height:.22},{at:230,height:.28},{at:400,height:.3},{at:590,height:.24}];
...
export function overpassPose(car){
 ...
 if(car.hop){const k=car.hop.t/.35;return {y:Math.sin(Math.PI*k)*car.hop.height,pitch:Math.cos(Math.PI*k)*.12,air:false};}
